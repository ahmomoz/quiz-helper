  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="aspect-square border-3 border-theme-border bg-theme-accent shadow-[4px_4px_0px_0px_var(--color-border)] flex flex-col items-center justify-center p-2 text-center text-theme-text">
          <Cpu size={32} className="mb-2" />
          <span className="font-black text-xs uppercase">{UI_TEXT.quiz.engineOptimized}</span>
        </div>
        <div className="aspect-square border-3 border-theme-border bg-theme-secondary shadow-[4px_4px_0px_0px_var(--color-border)] flex flex-col items-center justify-center p-2 text-center text-theme-text">
